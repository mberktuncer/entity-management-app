...
@RestController
@RequestMapping("/api/accounts/usd-account")
public class UsdAccountController {

    private final AccountService accountService;

    public UsdAccountController(@Qualifier("UsdAccountService") AccountService accountService){
