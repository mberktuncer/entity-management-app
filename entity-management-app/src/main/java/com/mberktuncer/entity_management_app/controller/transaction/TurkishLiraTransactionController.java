...
import static com.mberktuncer.entity_management_app.constants.Constants.QUALIFIER_TL;

@RestController
@RequestMapping("/api/transaction/turkish-lira")
public class TurkishLiraTransactionController {

    private final TransactionService transactionService;

    public TurkishLiraTransactionController(@Qualifier(QUALIFIER_TL) TransactionService transactionService){
