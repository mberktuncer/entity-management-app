...
import static com.mberktuncer.entity_management_app.constants.Constants.QUALIFIER_USD;

@RestController
@RequestMapping("/api/transaction/usd")
public class UsdTransactionController {

    private final TransactionService transactionService;

    public UsdTransactionController(@Qualifier(QUALIFIER_USD) TransactionService transactionService){
    ...
    @PutMapping("/transferToTlAccount")
    public ResponseEntity<CreateTransactionResponse> transferToTlAccount(@RequestBody CreateTransactionRequest createTransactionRequest){
        return ResponseEntity.ok(transactionService.transferToDifferentAccountType(createTransactionRequest));
    }
